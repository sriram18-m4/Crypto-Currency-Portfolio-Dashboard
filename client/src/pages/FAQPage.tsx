  ...
  return (
    <main className="px-8 max-w-[940px] mx-auto">
      ...
      <section className="mb-8">
        <h3 className="text-xl mb-2 font-medium">1. What is Vaultx?</h3>
        <p>
          Vaultx is a cryptocurrency dashboard that allows you to track your
      ...
      <section className="mb-8">
        <h3 className="text-xl mb-2 font-medium">
          4. Where does Vaultx get its data from?
        </h3>
        <p>
          All market data and cryptocurrency information on Vaultx are
          sourced from{" "}
          <a
      ...
      <section className="mb-8">
        ...
        <p>
          Market data on Vaultx is updated in real-time, providing you with
      ...
      <section className="mb-8">
        <h3 className="text-xl mb-2 font-medium">
          6. Can I trust the data provided on Vaultx?
        </h3>
        <p>
      ...
      <section className="mb-8">
        ...
        <p>
          ...
          <a href="mailto:blackboxarmani@gmail.com" className="underline">
            blackboxarmani@gmail.com
          </a>
          .
        </p>
      </section>
